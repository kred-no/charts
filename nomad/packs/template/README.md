...
```
nomad-pack run template --var message="Hola Mundo!"
```
...
balance the Consul service `template-service`, which is the default value
...
- `consul_service_name` (string) - The consul service name for the template
  application
